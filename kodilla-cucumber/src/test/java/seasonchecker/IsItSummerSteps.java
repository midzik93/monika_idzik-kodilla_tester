...
public class IsItSummerSteps {
    ...
    @Given("today is 10th day of June>")
    public void today_is_10th_day_of_june() {
        this.today = MonthDay.of(6, 10);
    }

    @Given("today is 20th day of February>")
    public void today_is_20th_day_of_february() {
        this.today = MonthDay.of(1, 20);
    }
