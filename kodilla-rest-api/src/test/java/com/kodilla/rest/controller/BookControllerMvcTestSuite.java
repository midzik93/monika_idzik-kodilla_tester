...
public class BookControllerMvcTestSuite {
    ...
    public void shouldFetchBooks() throws Exception {
        ...
        booklist.add(new BookDto("Test1", "Autor1"));
        booklist.add(new BookDto("Test2", "Autor2"));
...
//MockMvcRequestBuilders.get("/books") tworzy obiekt RequestBuilder, który reprezentuje zapytanie GET na endpoint /books.